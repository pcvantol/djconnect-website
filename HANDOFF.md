...
- Current released version `3.1.37` adds the public Support page with
  `support@djconnect.dev` as the primary support address and routes public
  footer support links through that page.
