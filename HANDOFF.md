...
- Current released version `3.1.40` adds the homepage carousel controls and
  animation, TestFlight and Privacy Policy pages, and clearer Spotify OAuth
  setup guidance for user-owned Spotify Developer apps.
