...
- Current released version `3.1.41` adds Support and Privacy links to the
  homepage navigation and refreshes bootstrap hygiene around AI-assisted
  development review and secret handling.
