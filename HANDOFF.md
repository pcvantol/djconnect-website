...
- Current released version `3.1.38` adds the Voice Assistant setup route and
  explanation page for DJConnect as a Home Assistant Assist Conversation Agent,
  documents ESPHome-powered voice assistants on the Spraak page and points the
  Support page GitHub Issues fallback to the main `pcvantol/djconnect` repo.
