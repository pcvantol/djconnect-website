...
### Static Regression Tests Over Browser Automation

The test suite uses Node's built-in test runner and file inspection rather than a browser runner. Tests assert route links, version consistency, copy contracts, translation coverage, download embed contracts, release script behavior and SEO/social metadata.
