...
DOC_FILES=(README.md HANDOFF.md TESTS.md TODO.md ISSUES.md CHANGELOG.md TECHNICAL_DESIGN.md CHAT_BOOTSTRAP.md SYNC_PROMPTS.md)
FORBIDDEN_CANONICAL_COPIES=(PRODUCT_ROADMAP.md HA_SYNC_PROMPT.md ESP_SYNC_PROMPT.md IOS_MACOS_APP_HANDOFF.md APPLE_APP_SYNC_PROMPTS.md docs/SYNC_PROMPTS.md)
...
node scripts/validate-sync-prompt-pointer.mjs SYNC_PROMPTS.md
